...
{`${styles['dream-text']} ${styles['p']}`}
{`${styles['main-container']} ${styles['contact-color']}`}

{`row ${styles.myCustomClassName}`}
{`page-footer ${styles['footer-bg']}`}

{`col-12 ${styles.subhead}`}
{`${styles['breadcrumb-item']} ${styles.active}`}
{`${styles['main-container']} ${styles.subhead}`}
